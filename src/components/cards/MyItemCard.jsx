...
export default function MyItemCard({ product, handleDeleteItem, handleEditItem }) {
  ...
  return (
    <div className="w-full flex justify-center">
      <div className="flex flex-col gap-4 bg-white shadow-lg px-5 py-5 rounded-2xl w-[750px] ">
            ...
            <div className="flex flex-1 justify-between">
              <div className="flex gap-4">
                ...
                <Link to={`/single-product/${product.id}`}>
                  <div className=" flex gap-2 items-center pt-2 text-viewProduct text-lg font-bold hover:underline cursor-pointer">
                    View Product
                    <span>
                      <FaArrowRight />
                    </span>
