                        ...
                        <div className="flex flex-col items-center w-[50%] h-full p-10 pt-[80px]">
                            ...
                            <form className="w-[90%]">
                                <div className="relative z-0 w-full mb-6 group">
                                    <input type="email" onChange={handleInput} name="email" className="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-[1px] border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                                ...
                                <div className="relative w-full flex items-center mb-1 group">
                                    <input type={passwordVisible ? "text" : "password"} onChange={handleInput} name="password" className="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-[1px] border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                                    ...
                                    <div className="static">
                                        ...
                                        >
                                            {passwordVisible ? (
                                                <div className="hover:cursor-pointer"><BsEyeFill /></div>
                                            ) : (
                                                <div className="hover:cursor-pointer"><BsEyeSlashFill /></div>
                                            )}
                                        </div>
                                    </div>
                                </div>
