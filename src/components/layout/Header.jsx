...
export default function Header() {
    ...
    return (
        <header className=" flex justify-center items-center w-full h-[85px] bg-white drop-shadow-xl">
            <div className="flex justify-center items-center gap-[100px]">
                ...
                <div className="flex items-center justify-center gap-5">
                    ...
                    <div className="hover:cursor-pointer flex justify-center items-center gap-1" onClick={() => onOpenModal("checkoutModal")}><FaRegCommentAlt />ข้อความ</div>
                    <div className="hover:cursor-pointer flex justify-center items-center gap-1" onClick={() => onOpenModal("loginModal")} ><FaRegUserCircle />เข้าสู่ระบบ</div>
                </div>
            </div>
