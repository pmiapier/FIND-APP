...
export default function AddProductPage() {
  ...
  return (
    <>
      {isOpenModal && modalType === "addProductModal" && (
        <div className="fixed bottom-0 left-0 flex justify-center items-center h-full w-full backdrop-blur  z-50">
          <div className="relative flex flex-col items-center justify-center  drop-shadow-2xl rounded-2xl bg-white">
            <button
            ...
            <form
              ...
              className="flex flex-col gap-5 w-[1300px] rounded-2xl px-12 pt-5 pb-12 bg-white
        shadow-lg"
            >
