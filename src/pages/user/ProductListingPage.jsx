            ...
            <div className="px-[12rem]">
                <div className="flex space-x-4 space-y-4">
                    ...
                    <div className="w-9/12 space-y-4">
                        <div className="grid grid-cols-3 gap-4">{product ? product.map((el, idx) => <ProductCard key={idx} item={el} />) : null}</div>
                        <div className="flex justify-between">
                            <p className="">Showing 1 to {countItems>=15?15:countItems} of {countItems} results</p>
